...
const buttonVariants = cva(
  "inline-flex items-center justify-center whitespace-nowrap rounded-lg text-sm font-medium transition-all duration-200 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-accent/50 disabled:pointer-events-none disabled:opacity-50",
  {
    variants: {
      variant: {
        default: "bg-accent text-white hover:bg-accent-600 shadow-lg shadow-accent/25",
        destructive: "bg-danger text-white hover:bg-danger-600",
        outline: "border border-[#E2E8F0] bg-transparent hover:bg-white hover:text-[#0F172A]",
        secondary: "bg-white text-[#0F172A] hover:bg-[#E2E8F0]",
        ghost: "hover:bg-white hover:text-[#0F172A]",
